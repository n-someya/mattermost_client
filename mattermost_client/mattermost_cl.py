...
class MatterMostClient(object):
    ...
    def send_message(self, message, username='PythonClient', icon_url=None):
        """
        :param message: message which you want to send.
        :param username: username shown on chat.(default: PythonClient)
        :param icon_url: icon shown on chat. you specify url for image.(default: None)
        ...
        resp = requests.post(self.__mattermosturl, headers=header, data=json.dumps(payload))
